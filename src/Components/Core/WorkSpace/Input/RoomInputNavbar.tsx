  ...
  return (
    <>
      <div className="flex justify-between w-full items-center pt-2 bg-slate-200 text-green-700">
        <div className={"bg-white rounded-t-[5px] px-5 py-[10px] text-s cursor-pointer"}>
          Inputs
        </div>
        <button onClick={handleClear} className="bg-white rounded-md px-4 py-[8px] mr-4 mb-2 text-xs cursor-pointer text-green-700 border-2 border-slate-300">
          Clear
        </button>
      </div>
